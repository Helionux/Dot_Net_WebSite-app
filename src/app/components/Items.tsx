    ...
    return (
        <div  className=" max-w-7xl mx-auto mt-20">
            <div className=" items-center  w-full justify-between z-10 bg-white/95 px-8">
                ...
                <div className=" mt-5 grid grid-cols-4 divide-x text-justify gap-6 *:pr-6">
                    <div>
                        <div className="text-[#512BD4] ">
                            <HandFist />
                            <h2 className="font-bold font-grotesk text-[20px] mt-3">Boost your career</h2>
                        </div>
                        <p>Relevant content: real-life feedback, best practices, career coaching, resume or LinkedIn profile reviews.</p>
                    </div>
                    <div>
                        <BookOpenText />
                        <h2 className="font-bold font-grotesk text-[20px] mt-3">Learn by doing</h2>
                        <p>Guided workshops and labs allow you to code, test, and experiment. </p>
                    </div>
                    <div>
                        <UserRound />
                        <h2 className="font-bold font-grotesk text-[20px] mt-3">Meet the ecosystem</h2>
                    ...
                    <div>
                        <RefreshCcw />
                        <h2 className="font-bold font-grotesk text-[20px] mt-3">Stay up to date</h2>
